...
{
    deepblue::http::HttpRequestParser parser;
    std::string tmp = str;
    ...
    {
        deepblue::http::HttpRequest::ptr req = parser.getData();
...
{
    deepblue::http::HttpResponseParser parser;
    std::string tmp = str;
    ...
    {
        deepblue::http::HttpResponse::ptr rsp = parser.getData();
...
int main(int argc, char *argv[])
{
    ...
    std::cout << "================test_request_chunked_data================" << std::endl;
    test_request(test_request_chunked_data);

    std::cout << "================test_response_data================" << std::endl;
