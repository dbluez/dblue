...
int main()
{
    ...
    pr.push_back(calcuPr(4,94,25,-150)); 
    pr.push_back(calcuPr(4,96,25,-150));
    pr.push_back(calcuPr(4,105.5,15,-150));
    pr.push_back(calcuPr(4,109.3,15,-150));
    pr.push_back(calcuPr(4,114,15,-150));
    pr.push_back(calcuPr(4,121.7,15,-150));
