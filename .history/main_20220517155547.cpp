...
int main()
{
    ...
    pr.push_back(calcuPr(4,99,15,-43)); 
    pr.push_back(calcuPr(4,105,15,-49));
    pr.push_back(calcuPr(4,105.5,15,-49));
    pr.push_back(calcuPr(4,109.3,15,-53));
    pr.push_back(calcuPr(4,114,15,-52));
    pr.push_back(calcuPr(4,121.7,15,-60));
