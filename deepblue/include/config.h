#ifndef __DEEPBLUE_CONFIG_H__
#define __DEEPBLUE_CONFIG_H__
...
namespace deepblue
{
    ...
    public:
        ...
        std::string toString() override
        {
            ...
            {
                DEEPBLUE_LOG_ERROR(DEEPBLUE_LOG_ROOT()) << "ConfigVar::toString exception "
        ...
        bool fromString(const std::string &val) override
        {
            ...
            {
                DEEPBLUE_LOG_ERROR(DEEPBLUE_LOG_ROOT()) << "ConfigVar::fromString exception "
    ...
    public:
                                                 ...
                                                 const T &default_value, const std::string &description = "")
        {
            ...
            if (it != GetDatas().end())
            {
                ...
                if (tmp)
                {
                    DEEPBLUE_LOG_INFO(DEEPBLUE_LOG_ROOT()) << "Lookup name=" << name << " exists";
                    return tmp;
                }
                else
                {
                    DEEPBLUE_LOG_ERROR(DEEPBLUE_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
            ...
            {
                DEEPBLUE_LOG_ERROR(DEEPBLUE_LOG_ROOT()) << "Lookup name invalid " << name;
