 ...
 * @date 2019-06-05
 * @copyright Copyright (c) 2019年 deepblue.yin All rights reserved (www.deepblue.top)
 */
#ifndef __DEEPBLUE_ADDRESS_H__
#define __DEEPBLUE_ADDRESS_H__
...
namespace deepblue
{
    ...
    public:
         ...
         * @param[in] host 域名,服务器名等.举例: www.deepblue.top[:80] (方括号为可选内容)
    ...
    public:
         ...
         * @param[in] address 域名,IP,服务器名等.举例: www.deepblue.top
         * @param[in] port 端口号
